...
namespace HelloWorld { 
    ...
    //  The statement creates a class named - 'Hello' in C#. Since, C# is an object-oriented programming language, creating a class is mandatory for the program’s execution.
    class Hello { 
          
        //  Here 'static' keyword tells us that this method is accessible without instantiating the class. 'void' keyword tells that this method will not return anything.
        //  The execution of every C# program starts from the Main() method.
        static void Main(string[] args) { 
              
            // WriteLine() is a method of the 'Console' class defined in the System namespace. This is the piece of code that prints Hello World! to the output screen.
